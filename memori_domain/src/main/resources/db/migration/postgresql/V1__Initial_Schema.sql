    ...
    create table app_user (
        ...
        tier smallint not null check (tier between 0 and 1),
    ...
    create table app_user_role (
        role smallint not null check (role between 0 and 0),
        id bigint not null,
        user_id varchar(255),
        primary key (id)
    );
    ...
    create table deck_settings (
        ...
        interday_priority smallint not null check (interday_priority between 0 and 3),
        is_default boolean not null,
        max_new_cards_per_day integer not null,
        max_review_per_day integer not null,
        maximum_answer_seconds integer not null,
        new_priority smallint not null check (new_priority between 0 and 3),
        review_priority smallint not null check (review_priority between 0 and 3),
    ...
    create table study_option (
        mode smallint not null check (mode between 0 and 1),
        sort_option smallint not null check (sort_option between 0 and 8),
        id uuid not null,
        primary key (id)
    );
